          ...
          <div class="card-body">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 mr-4 symbol symbol-65 symbol-circle">
                <img src="/img/vueJS.png" alt="image" />
              </div>
              <!--end::Pic-->
              <!--begin::Info-->
              <div class="d-flex flex-column mr-auto">
                <!--begin: Title-->
                <a href="#" class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1">{{ course.name }}</a>
                <span class="text-muted font-weight-bold">Michael García</span>
                <!--end::Title-->
              </div>
              <!--end::Info-->
            </div>
            ...
            <div class="d-flex flex-wrap mt-14">
              <div class="mr-12 d-flex flex-column mb-7">
                <span class="d-block font-weight-bold mb-4">Fecha Inicio</span>
                <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text">
                  14 Jan, 16
                </span>
              </div>
              <div class="mr-12 d-flex flex-column mb-7">
                <span class="d-block font-weight-bold mb-4">Duración</span>
          ...
          <div class="card-footer d-flex align-items-center">
            <div class="d-flex">
              <div class="d-flex align-items-center mr-7">
                ...
                <a href="#" class="font-weight-bolder text-primary ml-2">Temario</a>
              </div>
              <div class="d-flex align-items-center mr-7">
                <span class="svg-icon svg-icon-gray-500">
                ...
                <a href="#" class="font-weight-bolder text-primary ml-2">648 Comentarios</a>
              </div>
            </div>
            <button type="button" class="btn btn-secondary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">
              Detalles
            </button>

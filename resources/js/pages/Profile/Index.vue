        ...
        <div class="card-body pt-4">
          ...
          <div class="d-flex align-items-center">
            <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
              <div class="symbol-label" :style="`background-image: url('${authUser.third.photo_url}')`"></div>
          ...
          <div class="py-9">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              <span class="text-muted">{{ authUser.third.mobile }}</span>
            </div>
          ...
          <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
            ...
            <div class="navi-item mb-2">
              <BLink :to="{ name: 'ProfilePersonalInfo' }" class="navi-link py-4" exact-path exact-active-class="active">
                <span class="navi-icon mr-2">
                  <span class="svg-icon">
            ...
            <div class="navi-item mb-2">
              <BLink :to="{ name: 'ProfileAccountInfo' }" class="navi-link py-4" exact-path exact-active-class="active">
                <span class="navi-icon mr-2">
                  <span class="svg-icon">

...
<head>
	...
	<link href="{{ asset ('metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.4') }}" rel="stylesheet" type="text/css" />
	<!--end::Page Vendors Styles-->
	<!--begin::Global Theme Styles(used by all pages)-->
	<link href="{{ asset ('metronic/assets/plugins/global/plugins.bundle.css?v=7.0.4') }}" rel="stylesheet" type="text/css" />
	<link href="{{ asset ('metronic/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.4') }}" rel="stylesheet" type="text/css" />
								...
								<div class="col-xl-4">
									...
									<div class="card card-custom gutter-b card-stretch">
										...
										<div class="card-body d-flex flex-column px-0">
											<!--begin::Chart-->
											<div id="kt_tiles_widget_1_chart" data-color="danger" style="height: 150px">
											</div>
											<!--end::Chart-->
											<!--begin::Items-->
											<div class="flex-grow-1 card-spacer-x">
													...
													<div class="d-flex align-items-center mr-2">
														<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
															<div class="symbol-label">
																<img src="metronic/assets/media/svg/misc/006-plurk.svg" alt=""
																	class="h-50" />
															</div>
														</div>
														<div>
												...
												<div class="d-flex align-items-center justify-content-between mb-10">
													<div class="d-flex align-items-center mr-2">
														<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
															<div class="symbol-label">
																<img src="metronic/assets/media/svg/misc/015-telegram.svg" alt=""
																	class="h-50" />
															</div>
														</div>
														<div>
											...
											<div class="card card-custom gutter-b" style="height: 150px">
												...
												<div
													...
													<div class="mr-2">
														...
														<div class="text-dark-50 font-size-lg mt-2">Generate the latest
															CRM Report</div>
													</div>
										...
										<div class="col-xl-6">
											...
											<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch"
												...
												<div
													...
													<a href='#'
														class="btn btn-link btn-link-warning font-weight-bold">Create
														Report

            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div
                        ...
                        <span
                            class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">Usuario
                            1</span>
                    ...
                    <div class="navi navi-spacer-x-0 pt-5">
                        ...
                        <div class="navi-footer px-8 py-5">
                            <a href="custom/user/login-v2.html" target="_blank"
                                class="btn btn-light-primary font-weight-bold">Salir</a>
                            <a href="custom/user/login-v2.html" target="_blank"
                                class="btn btn-clean font-weight-bold">Cambiar Plan</a>
                        </div>
                        <!--end::Footer-->
                    </div>
                    <!--end::Nav-->
